import { Star, Clock, MapPin, X, Heart, Calendar, Check } from 'lucide-react';
...
export function EventDetailSheet({ event, open, onClose }: EventDetailSheetProps) {
  ...
  const getFormattedDate = () => {
    ...
    return { day, month, year, weekday: 'Tuesday' };
  };
              ...
              <div className="relative h-96">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    >
                      <div className="text-black text-xl font-bold">$45,90</div>
                    </motion.div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    When the concert {event.title} will be on stage in 10:00. 
                    This is an amazing opportunity to experience live music and connect with fellow enthusiasts. 
                    The venue offers excellent acoustics and comfortable seating for all attendees.
                  </p>
                </div>
