import { Calendar, MapPin, X, Download, QrCode, Check } from 'lucide-react';
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div>
                      <div className="flex items-center gap-4 mb-1">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">10:00 PM - End</div>
                        </div>
                      </div>
                    </div>
                    <motion.div 
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm leading-relaxed">
                      When the concert {ticket.title} will be on stage in 10:00. 
                      List of songs: Forget It, When I'm Down, All That and Life Goes On which will be sung on the {ticket.venue} stage.
                    </p>
                  </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-muted-foreground text-sm flex-1">
                          {ticket.title} singing is Dec 29th at 10:00 PM
                        </p>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="glass backdrop-blur-xl w-6 h-6 rounded-full flex items-center justify-center border border-white/20 flex-shrink-0 mt-0.5">
                        ...
                        <p className="text-muted-foreground text-sm flex-1">
                          Meet and greet with {ticket.artist} on Dec 30th
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="glass backdrop-blur-xl rounded-2xl p-4 border border-white/10">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-foreground text-sm font-medium">Number of seats</span>
                      <span className="text-muted-foreground text-xs">{ticket.availableSeats} seats left</span>
                    </div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                          ...
                          <div className="text-black font-semibold">Dec 29, 2022</div>
                        </div>
                        <div>
                          <div className="text-gray-400 text-xs mb-1">Time</div>
                          <div className="text-black font-semibold">10:00 PM</div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div>
                          ...
                          <div className="text-black font-semibold">{ticket.venue}</div>
                        </div>
                        <div>
                          <div className="text-gray-400 text-xs mb-1">Seat</div>
                          <div className="text-black font-semibold">No seat</div>
                        </div>
                      </div>
