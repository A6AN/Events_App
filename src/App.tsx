...
function AppContent() {
  ...
  return (
    <div className="h-screen w-full max-w-lg mx-auto relative flex flex-col overflow-hidden astral-bg grain">
      ...
      {/* Floating Glass Pill Navigation - OUTSIDE overflow container */}
      <motion.div
        className="fixed bottom-6 left-4 right-4 max-w-lg mx-auto h-16 rounded-full z-50 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.1)] border border-white/10 grid grid-cols-4 items-center px-2"
        style={{
      ...
      {/* Floating Center FAB */}
      <motion.div
        className="fixed bottom-14 left-1/2 -translate-x-1/2 z-50 max-w-lg"
