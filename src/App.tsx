  ...
  return (
    <div className="h-screen w-full max-w-lg mx-auto relative flex flex-col overflow-hidden astral-bg grain">
      ...
      <div className="relative shrink-0 pb-6">
        ...
        <motion.div
          className="fixed bottom-6 left-4 right-4 max-w-lg mx-auto h-16 rounded-full glass backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.1)] border border-white/10 grid grid-cols-4 items-center px-2"
          style={{
