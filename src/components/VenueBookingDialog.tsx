          ...
          <div className="flex flex-col max-h-[90vh]">
            ...
            <div className="relative h-52 flex-shrink-0">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="absolute top-4 right-4 p-2.5 rounded-full bg-zinc-900/80 backdrop-blur-md hover:bg-amber-500 transition-colors border border-white/10"
              >
              ...
              <motion.div
                ...
                className="absolute top-4 left-4 flex items-center gap-1.5 bg-gradient-to-r from-amber-500 to-orange-500 px-3 py-1.5 rounded-full shadow-lg shadow-amber-500/40"
              >
            ...
            <div className="flex-shrink-0 p-5 bg-zinc-950 border-t border-white/10">
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button
                  onClick={handleBook}
                  className="w-full h-14 rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-white font-bold text-base shadow-xl shadow-amber-500/40"
                >
